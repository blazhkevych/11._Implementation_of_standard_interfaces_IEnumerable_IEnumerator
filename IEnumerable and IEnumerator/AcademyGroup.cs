...
namespace IEnumerable_and_IEnumerator
{
    ...
    internal class AcademyGroup : ICloneable, IEnumerable, IEnumerator
    {
        ...
        private AcademyGroup(List<Student> group)
        {
            _Group = group;
        }

        public AcademyGroup(Student[] students)
        {
            _students = new Student[students.Length];
            for (int i = 0; i < students.Length; i++)
            {
                _students[i] = new Student(students[i].Name, students[i].Surname, students[i].Age, students[i].Phone,
                    students[i].Average, students[i].NumberOfGroup);
            }
        }
        ...
        public object Current // Получает текущий элемент в коллекции.
        {
            get
            {
                ...
                return _students[_currentPosition];
            }
        }
        ...
        public bool MoveNext()
        {
            ...
            if (_currentPosition < _students.Length - 1)
            {
                _currentPosition++;
                return true;
            }
